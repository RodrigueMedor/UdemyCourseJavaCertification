...
public class StringConstructor {
	...
	public static void main(String[] args) {
		...
		/*
		 * Create a String from the integer array Note here: You cannot create a String
		 * with integer array with a simple one args constructor, so we'll use offset =
		 * 0 and length = the length of array, to get the full alphabet
		 */
