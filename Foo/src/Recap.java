...
public class Recap {
	...
	public static void equalLiteralReferences() {
		/*
		 * String literals automatically interned so all "hello" literals point to same
		 * reference in memory, in the string pool
		 */
		String s1 = "hello";
		String s2 = "hello";
		
		System.out.println("s1 and s2 are string literal assigned to String variables: (s1 == s2) =" +((s1 == s2)? "true": "false"));
	}
	   public static void StringConstructors() {
			...
			/*
			 * Now evaluates to false, strings do not point to same reference, and are not
